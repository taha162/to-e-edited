...
- **React Three Fiber / Three.js** (gyroscopic and exploded 3D systems)
- **cannon-es** (light mass, inertia, and damping simulation)
- **Lucide** (iconography)
- **TypeScript 5**
...
components/
  ...
  machine/
    GyroCoreStage.tsx          # rotating engineered hero core
    ExplodedPortfolioStage.tsx # project case exploded 3D assembly
    ScrollMachineOverlay.tsx   # cannon-es scroll force rail
    useCannonSpring.ts         # shared damped mass primitive
docs/
  scroll-physics-machine.md    # architecture, interaction map, performance strategy
```
